...
return array(
	...
	'components'=>array(		   
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=adrproduccionsql.cqybxkagrgmc.us-east-1.rds.amazonaws.com;dbname=dfornez_adr3',
			'emulatePrepare'   => true,
			'username'         => 'dfornez123',
			'password'         => 'Bridge2351$',
			'charset'          => 'utf8',
...
*/
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=localhost;dbname=dfornez_adr3',
			'emulatePrepare'   => true,
		...
		/*'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=45.79.146.118;dbname=dfornez_adr3',
			'emulatePrepare'   => true,
			'username'         => 'monty',
			'password'         => 'some_pass',
			'charset'          => 'utf8',
