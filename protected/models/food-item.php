...
<div class="container  view-food-item-wrap">
  ...
  <div class="row">
    ...
    <div class="col-md-3 ">              
       <img src="<?php echo FunctionsV3::getFoodDefaultImage($data['photo']);?>" alt="<?php echo $data['item_name']?>" title="<?php echo $data['item_name']?>" style="max-width: 200px !important;" class="logo-big">
    </div> <!--col-->
    <div class="col-md-9 ">
         <a href="javascript:close_fb();" style="margin-left: 90% !important;"><i class="fa fa-times" aria-hidden="true" style="font-size: 25px !important; color: gray;text-align:right;"></i></a>
       <h1 class="bold" style="margin-left: 65px !important;margin-top: 65px !important;"><?php echo qTranslate($data['item_name'],'item_name',$data)?></h1>
       <?php echo Widgets::displaySpicyIconNew($data['dish'],'dish-category');?> 
       <h2 style="margin-left: 65px !important;font-size: 18px !important;"><?php echo qTranslate($data['item_description'],'item_description',$data)?></h2>
    </div> <!--col-->
  </div> <!--row-->
  <!--ITEM NAME & DESCRIPTION--
  ...
  <div class="section-label">
    ...
    <div class="row">
       ...
       <div class="col-md-6 col-xs-6 border into-row">
         <a href="javascript:;" class="special-instruction orange-button inline">Instrucciones especiales</a>
       </div>
    </div> <!--row-->
  </div> <!-- section-label--> 
  ...
  ,array(
   'class'=>'uk-width-1-1',
   'placeholder'=>Yii::t("default","Favor indicar sus Instrucciones...")
  ))?>
  </div> <!--notes-wrap-->
...
<div class="row food-item-actions">
  ...
  <div class="col-md-4 col-xs-4 border into-row">
     <input type="submit" style="padding-right: 160px !important;" value="<?php echo empty($row)?Yii::t("default","añadir al carrito"):Yii::t("default","actualizar carrito");?>" 
