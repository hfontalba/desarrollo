...
<div class="blue_panel">
   ...
   <?php echo CHtml::textField('search_agent','',array(
     'placeholder'=>Driver::t("Ingresa nombre del conductor"),
     'class'=>"search_agent"
   ));?>
   ...
   <div class="row">
     ...
     <a href="javascript:setMapCenter();" title="<?php echo Driver::t("centrar mapa")?>"><i class="ion-ios-navigate-outline"></i></a>
     <a href="javascript:showAgentSearch();" title="<?php echo Driver::t("buscar conductor")?>" ><i class="ion-ios-search-strong"></i></a>
     <a href="javascript:loadAgentDashboard();" title="<?php echo Driver::t("actualizar")?>" ><i class="ion-android-refresh"></i></a>
...
<ul id="tabs">
 <li class="active"><span class="agent-active-total" >0</span> <?php echo Driver::t("Activos")?></li>
 <li><span class="agent-offline-total" >0</span> <?php echo Driver::t("No activos")?></li>
