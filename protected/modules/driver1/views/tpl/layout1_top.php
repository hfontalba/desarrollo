  ...
  <div class="col-md-4 border">
    ...
    <?php elseif ( $map_provider=="google.maps"):?>   
	    <?php echo CHtml::textField('search_map','',array(
	      'placeholder'=>Driver::t("Buscar en el mapa"),
    ...
    <div class="back-dashboard">
     ...
     <i class="ion-ios-arrow-thin-left"></i> <?php echo Driver::t("Regresar al panel")?>
     </a>
    </div>
   
  </div> <!--row-->
  
  <div class="col-md-2 border center-top-logo" style="width: 300px;">
    ...
    if(!empty($website_title)){
    	    } else echo Driver::t("Regresar al panel");
    ?>Así de Rápido - <b>CECOM</b>
    </a>
  </div>
   ...
   <i class="ion-android-menu"></i>
    ...
    <ul class="menu">
        ...
        <div class="popup_menu nav">
          <div class="row">
            <div class="col-md-6 ">
                <a href="<?php echo Yii::app()->createUrl('/driver')?>">
                  <i class="ion-grid"></i>
                  <p><?php echo Driver::t("Panel de control")?></p>
                </a>
            </div> <!--col-->
            <div class="col-md-6 ">
                <a href="<?php echo Yii::app()->createUrl('/driver/index/tasks')?>">
                  <i class="ion-ios-checkmark"></i>
                  <p><?php echo Driver::t("Tareas")?></p>
                </a>
            </div> <!--col-->            
            ...
            <div class="col-md-6 ">
                <a href="<?php echo Yii::app()->createUrl('/driver/index/agents')?>">
                  ...
                  <p><?php echo Driver::t("Conductores")?></p>
                </a>
            </div> <!--col-->            
            ...
            <div class="col-md-6 ">
                <a href="<?php echo Yii::app()->createUrl('/driver/index/settings')?>">
                  ...
                  <p><?php echo Driver::t("Configuración")?></p>
                </a>
            </div> <!--col-->            
            <?php endif;?>
            ...
            <div class="col-md-6 ">
                <a href="<?php echo Yii::app()->createUrl('/driver/index/reports')?>">
                  ...
                  <p><?php echo Driver::t("Reportes")?></p>
                </a>
            </div> <!--col-->    
            ...
            <div class="col-md-6 ">
                <a href="<?php echo Yii::app()->createUrl('/driver/index/pushlogs')?>">
                  ...
                  <p><?php echo Driver::t("Notificaciones")?></p>
                </a>
            </div> <!--col-->    
            ...
            <div class="col-md-6 ">
                <a href="<?php echo Yii::app()->createUrl('/driver/index/assignment')?>">
                  ...
                  <p><?php echo Driver::t("Asignaciones")?></p>
                </a>
            </div> <!--col-->    
      ...
      <li>
        ...
        title="<?php echo Driver::t("salir")?>" ><i class="ion-log-out"></i></a>
      </li>
