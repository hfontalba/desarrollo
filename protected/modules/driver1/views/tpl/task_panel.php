...
<ul id="tabs"> 
 <li class="active"><span class="task-total-unassigned">0</span> <?php echo Driver::t("Pendientes")?></li>
 <li><span class="task-total-assigned">0</span> <?php echo Driver::t("Asignadas")?></li>
 <li><span class="task-total-completed">0</span> <?php echo Driver::t("Completas")?></li>
</ul>
