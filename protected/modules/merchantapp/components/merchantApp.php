...
/** Codigo Modificado por:
	Henry J Fontalba L
	Objetivos: realizar la operacion para verificacion si un
	establecimiento necesita de un stock de inventario

	@params: $mtid 
	@return: --> un valor de verdadero o falso en caso de que necesite un inventario	
**/


	public static function getNeedInventory($mtid='')
	{

		$db_ext=new DbExt;
		$result = false;
		$sql ="SELECT a.`need_inventory`
				FROM {{merchant}}
