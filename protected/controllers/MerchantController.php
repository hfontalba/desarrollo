...
class MerchantController extends CController
{
     ...
     *	- MerchantController.php -> actionFoodItem() -> Se agregó la opción "ImportaCSV"
	...
	public function actionFoodItem()
	{
		...
		if (isset($_GET['Do'])){
			...
			} elseif ( $_GET['Do'] =="ListUpdate" ){
			    $this->render('food-item-list-update');
			} elseif ( $_GET['Do'] =="ListUpdateQuantity" ){
			    $this->render('food-item-list-update-quantity');
			} elseif ( $_GET['Do'] =="ImportarCSV" ){
			    $this->render('food-item-importar-csv');
	...
	{
		$this->crumbsTitle=t("Modulo de Importacion Automatico Json");
		$this->render('import-json');
	}
