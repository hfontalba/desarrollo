<div class="order-steps-container "><div class="order-steps-expander"> <div class="container"> <div class="title"><span class="trigger"></span> </div> </div> </div> </div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/1.6.4/jquery.js"></script>
<?php 
...
<div class="sections section-grey2 section-payment-option">
   <div class="container">
     ...
     <?php else :?> <!-- DELIVERY-->                          	       	      
      ...
      <div class="dl-padding"> 
		  <p>
	        <span style="font-size: 18px; font-weight: bold;"><?php echo clearString(ucwords($merchant_info['restaurant_name']))?> </span>
          ...
          <div class="dl-padding">      	        
            ...
            <div class="addressCard thumbnail col-sm-6">
						<div class="caption">
							<h4 class="">
							<a href="javascript:;" class="center edit_address_book block top10">Agregar una nueva dirección</a>
							</h4>
							<p class=""></p>
						</div>
						</div>
     ...
     <div class="col-md-5  sticky-div"><!-- RIGHT CONTENT STARTS HERE-->
       ...
       <div class="   relative new-cart ">
	       ...
	       <div class="item-order-listt-wrap">   
	       
          <h2 class="order-title-new" style="background-color: #325193; color: white; text-align: center !important;">Tu pedido</h2>
            ...
            <div style="background-color: #c7c7c7; padding: 25px; margin-top: 33px; margin-bottom: 33px;">
            <input type="checkbox" name="mycheckbox" id="mycheckbox" value="0" />
            <h3 style="font-weight: bold;color: black; font-size: 18px;">¿Ya realizaste el pago y lo reportaste?</h3>
            </div>
	          <div class="text-center ">
	          <a href="javascript:;" class="place_order green-button medium inline block"  id="mycheckboxdiv" style="background-color: #325193; display: none;">
	          ¡Pidemelo!
	          </a>
	          </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        document.title = 'Así de Rápido - Formas de pago';
    });
