  ...
  <div class="container">
   ...
   <div class="row">
     ...
     <div class="col-md-3 mobile-no-padding">
     	<div class="message-box" style="background-color: #fa9918;"><strong>Can’t find a Resturant?</strong><span>If you can't find the Resturant that you want to Order, request to add in our list</span>
     		<a href="https://docs.google.com/forms/d/e/1FAIpQLSd-rJgMUROmrJeWq_Yh-gHw9F1BWRSZfKV86yD6C8rR3p86Ug/viewform" class="request-btn" target="_blank">Resturant Request</a></div>

     	<div class="message-box" style="background-color: #60ba62;"><strong>I‘ m not Listed!</strong><span>is your resturant or busniess not listed on over site</span>
     		<a href="https://docs.google.com/forms/d/e/1FAIpQLSd-rJgMUROmrJeWq_Yh-gHw9F1BWRSZfKV86yD6C8rR3p86Ug/viewform" class="request-btn">Add your Business</a></div>
     </div>
