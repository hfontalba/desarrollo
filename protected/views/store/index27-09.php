    ...
    <div class="container">
        ...
        <div class=" download-app-text animated">
            <div class="download-app-wrap">
                <h4><a href="#" class="text-lt text-sp txcolor">Download the app</a></h4>
                ...
                <div class="download-from">
                    ...
                    <a href="#" class="pull-left" data-toggle="modal" data-target=".download-popup"><img src="https://asiderapido.com/images/google-play.png" alt="Google Play"></a>
                    <div class="clearfix"></div>
                </div>
            </div>
        </div>
