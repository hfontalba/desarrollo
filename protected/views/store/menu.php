...
<div class="container">
  <div class="row">
     ...
     <div class="" style="margin-top: 65px !important;">
      <div class="box-grey rounded  relative">
        ...
        <div class="inner line-top relative new-cart">
          ...
          <h2 class="order-title-new" style="background-color: #325193; color: white; font-weight: bold; text-align: center;">Tu pedido</h2>
           ...
           <?php endif;?>
	        ...
	        <a href="javascript:;" class="clear-cart">Borrar carrito</a>
        ...
        <div class="inner line-top relative delivery-option center dl-options">
           ...
           <h2 class="order-title-new">Opciones de compra</h2>
	       ...
	       <?php endif;?>  
	          ...
	          <span class="delivery-asap">
	           <?php echo CHtml::checkBox('delivery_asap',true,array('class'=>"icheck"))?>
	            <span class="text-muted"><?php echo Yii::t("default","Entregarmelo lo más pronto posible")?></span>	          
	         </span>       	         	        	     
	         <?php endif;?>    
	         </div>
           ...
           <?php if ( $checkout['code']==1):?>
              <a href="javascript:;" class="orange-button medium checkout">Pagar</a>
           <?php else :?>
...
<script type="text/javascript">
    var delivery_time = $('#delivery_time').clockpicker({
    placement: 'bottom',
    align: 'left',
    'default': 'now',
    twelvehour:true,
    donetext: 'Done',
    afterDone: function() {
        delivery_time.val(delivery_time.val().slice(0,-2)+' '+delivery_time.val().slice(-2));
    }
...
a.orange-button:hover, button.orange-button:hover, input.orange-button:hover, input.orange-button:focus, a.orange-button:focus, #menu .logout-menu a:hover {
	background-color: #299fd1!important;
    border-bottom: 0px solid #2167bb;
    box-shadow: 0 1px 2px 0 rgba(60,64,67,0.302), 0 1px 3px 1px rgba(60,64,67,0.149);
    font-size: 12px;
}
ul#tabs li.active {
    border-bottom: 2px solid #299fd1;
}
