...
<div class="section-grey2 section-receipt">
   <div class="inner">
      ...
      <!-- <div class="text-center bottom10">
	   ...
	   <tbody>	
	       <?php 
	       FunctionsV3::receiptTableRow('Nombre del comprador',$data['full_name']);
	       FunctionsV3::receiptTableRow('Establecimiento',clearString($data['merchant_name']));
	       if (isset($data['abn']) && !empty($data['abn'])){
	       	   FunctionsV3::receiptTableRow('ABN',$data['abn']);
	       }
	       FunctionsV3::receiptTableRow('Teléfono',$data['merchant_contact_phone']);
	       FunctionsV3::receiptTableRow('Dirección',$full_merchant_address);
	       ...
	       FunctionsV3::receiptTableRow('Forma de pago',
	       ...
	       FunctionsV3::receiptTableRow('No. de Referencia', Yii::app()->functions->formatOrderNumber($data['order_id']) );
	       ...
	       FunctionsV3::receiptTableRow('Fecha de pedido',  Yii::app()->functions->translateDate($trn_date) );
	       ...
	       if ($data['trans_type']=="delivery"){
	           ...
	           if (isset($data['delivery_time'])){
	       	   ...
	       	   FunctionsV3::receiptTableRow('Número de contacto',$data['contact_phone']);
