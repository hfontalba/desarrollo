     ...
     <div class="row">
        <div class="col-md-7">
          <div class="">
           ...
           <table class="table-order-details">
            <tr>
              <td class="a"><?php echo t("Nombre del establecimiento")?></td>
            ...
            <tr>
              <td class="a"><?php echo t("Hora del Delivery")?></td>
              <td class="b">: <?php echo t("1 hora aprox.")?></td>
            </tr>
            <?php endif;?>
            <?php endif;?>
           ...
           <?php FunctionsV3::sectionHeader('Tipo de pago seleccionado')?>
            </span>       
           <p>
           <?php 
          ...
          <a href="<?php echo $guestcheckout==true?Yii::app()->createUrl('/store/guestcheckout'):Yii::app()->createUrl('/store/paymentoption')?>">
           <i class="ion-ios-arrow-thin-left"></i> <?php echo t("Bolvar")?>
          </a>
        ...
        <div class="col-md-5 sticky-div">
          ...
          <div class=" new-cart">
             ...
             <div class="order-list-wrap">   
	           ...
	           <h2 class="order-title-new">Tu pedido</h2>
	           <div class="item-order-wrap"></div>
	         
	           <div class="text-center top25">
	             <a href="javascript:;" class="place_order green-button medium inline block" style="background: #325193;">
