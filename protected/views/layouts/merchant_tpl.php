...
<div class="header_wrap">
  <div class="left">
   <a href="<?php echo Yii::app()->request->baseUrl; ?>/merchant"><h1><?php echo Yii::t("default","Establecimientos")?></h1></a>
  </div>
  ...
  <h4 class="uk-h3" style="font-size: 14px;padding-top: 15px;margin-left: 45px;"><?php echo Yii::t("default","Published Merchant")?>?
  <?php 
...
<div class="main_wrapper">
  <div class="left_panel left left-wrap">
      <div class="menu">      
...
<script type="text/javascript">
  $(document).ready(function(){
    $(".slide-button").click(function(){
      $(".left-wrap").toggleClass("come-out");
       $(".main_content .new-inner").toggleClass("padding-tog");
    });
});
</script>
<style type="text/css">
