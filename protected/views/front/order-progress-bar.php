...
<?php if ($show_bar):?>
<div class="order-progress-bar" style="margin-top: 33px;">
  <div class="container">
      <div class="row">
      
        <div class="col-md-2 col-xs-2 ">
          <a class="active" href="<?php echo Yii::app()->createUrl('/store')?>">Buscar</a>  
        </div>
        ...
        <a class="<?php echo $step>=4?"active":"inactive"; echo $step==4?" current":"";?> "
         href="<?php echo Yii::app()->createUrl('store/guestcheckout')?>">Pagar</a>
        <?php else :?>
        <a class="<?php echo $step>=4?"active":"inactive"; echo $step==4?" current":"";?> "
         href="<?php echo Yii::app()->createUrl('store/paymentoption')?>">Pagar</a>
        <?php endif;?>
        </div>
        
        <div class="col-md-2 col-xs-2 ">
        <a class="<?php echo $step>=5?"active":"inactive"; echo $step==5?" current":"";?> "
         href="javascript:;">Confirmar orden</a>
        </div>
        
        <div class="col-md-2 col-xs-2 ">
        <a class="<?php echo $step>=6?"active":"inactive"; echo $step==6?" current":"";?> "
         href="javascript:;">Recibo</a>
        </div>
