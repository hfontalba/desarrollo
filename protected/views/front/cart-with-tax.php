...
if (isset($data_total['cargos'])){
	if ($data_total['cargos']>0){
		$total_plus_charges+=$data_total['cargos'];
	}
}
...
$data_total['taxable_total']=($data_total['total']*0.16);
//eureka
$cargos=$data_total['total']*0.05;
$totalADR=($data_total['total']+$cargos)*0.16;
$data_total['subtotal']=$data_total['total']+$cargos+$data_total['merchant_packaging_charge'];
$total_final=$data_total['subtotal']+$totalADR;
...
<div class="row" id="new-cart">
  <div class="col-xs-9 txt-indent" ><?php echo t("Cargos por uso de plataforma web")?></div>
  <div class="col-xs-3 text-right">
    <?php echo FunctionsV3::prettyPrice($cargos)?>
  </div>
</div> <!--row-->
...
<div class="row" id="new-cart">
  ...
  <div class="col-xs-3 text-right">
    <?php echo FunctionsV3::prettyPrice($totalADR)?>
  </div>
</div> <!--row-->
<?php endif;?>
...
<div class="row" id="new-cart" style="border-bottom:0;">
  ...
  <div class="col-xs-3 text-right">
    <b><?php echo FunctionsV3::prettyPrice($total_final) ?></b>
  </div>
</div> <!--row-->
<?php endif;?>
