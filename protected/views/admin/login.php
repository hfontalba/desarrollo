...
<div class="lg-form">
   ...
   <h3 class="uk-h3" style="text-transform: none;">¡Bienvenido al panel de administración!</h3>   
   ...
   <div class="uk-form-row">   
   <button class="uk-button uk-width-1"><?php echo Yii::t("default","Submit")?></button>
   </div>
