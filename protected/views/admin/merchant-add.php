...
<!-- Modificaion Realizada por Henry Fontalba 
     Objetivo: Realizar la verificacion si un establecimiento 
     necesita disponer de un inventario o no
     fecha: 30/09/2019 -->

         <div class="uk-form-row">
           <label class="uk-form-label"><?php echo Yii::t("default","Dispone de Inventario")?></label>
           <?php  
            echo CHtml::checkBox('need_inventory', $data['need_inventory']==2?true:false,array(
                  'value'=>2,
                  'class'=>"icheck"
              ))
           ?>
         ...
         <div class="uk-form-row">
           <label class="uk-form-label"><?php echo Yii::t("default","Top 5")?></label>
           <?php  
            // echo CHtml::checkBox('need_inventory', $data['need_inventory']==2?true:false,array(
            //       'value'=>2,
            //       'class'=>"icheck"
