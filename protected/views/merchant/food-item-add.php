...
/*** obtengo el valor para ver si el establecimiento tenga activada la opcion del merchant ***/
$invent= Yii::app()->functions->getNeedInventory(Yii::app()->functions->getMerchantID());
$inventory=$invent['need_inventory'];
//print_r($inventory);
	...
	<li>
	  <div class="uk-grid">
	    <?php if ($merchant_apply_tax==1):?>
		    ...
		    <div class="uk-width-1-3"><?php echo Yii::t("default","Price With Tax")?></div>
		    <?php if($inventory > 1): ?>
		   		 <div class="uk-width-1-3"><?php echo Yii::t("default","Quantity")?></div>
		   	<?php endif ?>
		...
		<li class="<?php echo $x==count($price)?"price_wrap":"";?>">
		  <div class="uk-grid">
		    ...
		    <span class="price_with_tax">
		     ...
		     <?php if($inventory > 1): ?>
		      	<div class="uk-width-1-3">
		      		<?php echo CHtml::textField('item_cant','',array('class'=>'uk-form-width-medium numeric_only'))?>
