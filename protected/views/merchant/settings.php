...
<?php 
//echo CHtml::checkBox('merchant_preorder',Yii::app()->functions->getOption("merchant_preorder",$merchant_id)==1?true:false,array('class'=>"icheck",'value'=>1));
?>
</div>-->
...
<?php 
//echo CHtml::textArea('merchant_close_msg',Yii::app()->functions->getOption("merchant_close_msg",$merchant_id),array('class'=>"uk-form-width-large"));
?>
</div>-->
...
<?php //echo CHtml::textField('merchant_holiday[]',$m_h,array('class'=>"j_date_normal small_date"));?>
...
<!--<div class="holiday_row">
<?php //echo CHtml::textField('merchant_holiday[]','',array('class'=>"j_date_normal small_date"));?>
</div>-->
...
<?php 
//echo CHtml::textArea('merchant_close_msg_holiday',Yii::app()->functions->getOption("merchant_close_msg_holiday",$merchant_id),array('class'=>"uk-form-width-large"));
?>
</div>-->
