...
<div class="uk-panel uk-panel-box uk-width-medium-1-3">
   ...
   <h3 class="uk-h3" style="text-transform: none !important;">Plataforma de Establecimientos</h3>   
   ...
   <div class="uk-form-row">     
       <div class="uk-form-icon uk-width-1">
        ...
        <?php echo CHtml::passwordField('password','',array('class'=>"uk-width-1",'placeholder'=>Yii::t("default","Clave"),
        'data-validation'=>"required"
        ));?>
       </div>     
   </div>        
   ...
   <div class="uk-form-row">   
   <button class="uk-button uk-width-1"><?php echo Yii::t("default","Ingresar")?> <i class="uk-icon-chevron-circle-right"></i></button>
   </div>
   
   <p><a href="javascript:;" class="mt-fp-link"><?php echo Yii::t("default","¿Olvidó su contraseña?")?></a></p>
